...
pVer:			адрес по которому будет сохранено время получения. (соответствует GetTickCount()). (может быть 0)
/////////////////////////////////////////////////////////
функция возврацщает 0 в случае успешного завершения
...
/*/////////////////////////////////////////////////////////
 vi_netctrl_GetTimes
/////////////////////////////////////////////////////////
получение времени последнего обращения к сети ( см. GetTickCount() )
/////////////////////////////////////////////////////////
int	vi_netctrl_GetTimes(VI_MODULE module, DWORD *ptRcv,DWORD *ptSnd)
/////////////////////////////////////////////////////////
module:			текущий модуль
...
public:
	...
	int	GetTimes(DWORD *ptRcv,DWORD *ptSnd);
...
VINETCTRL_API int vi_netctrl_GetTimes(VI_MODULE module, DWORD *ptRcv, DWORD *ptSnd);
...
inline int	CVINetModuleDll::GetTimes(DWORD *ptRcv,DWORD *ptSnd)
{
	if (!IsOk()) return 0;
